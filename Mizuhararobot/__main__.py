...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am Akagi a group manager bot.
You can find my list of available commands with /help.
"""


BOT_IMG = "https://telegra.ph/file/c452242ceccd9e33db9d6.jpg"




HELP_STRINGS = """
Hello I'm  Akagi. You can have a look at the following for an idea of some of \
the things I can help you with.

*Main* commands available:[:.:](https://telegra.ph/file/d9b31b2593840f04b9b09.png)
...
def start(update, context):
    if update.effective_chat.type == "private":
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="➕️Add Akagi to your group",
                            url="t.me/{}?startgroup=true".format(context.bot.username))
                    ],
                    [
                        InlineKeyboardButton(
                            text="Support Chat ",
                            url="https://t.me/ZeroChatSupport"),
                        InlineKeyboardButton(
                            text="📍Updates ",
                    ...
                    [
                        InlineKeyboardButton(
                            text="Help",
                            url="https://t.me/AkagiAzurBot?start=help")
                    ]]))
        ...
        update.effective_message.reply_text("Heya, my name is Akagi")
